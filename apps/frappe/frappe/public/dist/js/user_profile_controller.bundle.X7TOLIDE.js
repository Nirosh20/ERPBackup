(() => {
  ...
  var UserProfile = class {
    ...
    setup_user_search() {
      this.$user_search_button = this.page.set_secondary_action(__("Change User"), () => this.show_user_search_dialog(), { icon: "change", size: "sm" });
    }
    ...
    get_user_points() {
      return frappe.xcall("frappe.social.doctype.energy_point_log.energy_point_log.get_user_energy_and_review_points", {
        user: this.user_id
      }).then((r) => {
        if (r[this.user_id]) {
...
//# sourceMappingURL=user_profile_controller.bundle.X7TOLIDE.js.map
