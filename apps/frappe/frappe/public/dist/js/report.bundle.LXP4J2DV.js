(() => {
        ...
        switch (condition) {
          ...
          case "in":
            return __("{0} is one of {1}", [
              __(label),
              frappe.utils.comma_or(value.map((v) => frappe.format(v, docfield)))
            ]);
          case "not in":
  ...
  frappe.views.QueryReport = class QueryReport extends frappe.views.BaseList {
    ...
    add_prepared_report_buttons(doc) {
      if (doc) {
        ...
        const days_old = frappe.datetime.get_day_diff(frappe.datetime.now_datetime(), doc.report_end_time);
        if (days_old > 1) {
  ...
  // frappe-html:/home/nirosh/frappe-bench/apps/frappe/frappe/public/js/frappe/views/reports/print_grid.html
...
`;
  ...
  // frappe-html:/home/nirosh/frappe-bench/apps/frappe/frappe/public/js/frappe/views/reports/print_tree.html
...
`;
  ...
  // frappe-html:/home/nirosh/frappe-bench/apps/frappe/frappe/public/js/frappe/ui/group_by/group_by.html
...
`;
  ...
  frappe.ui.GroupBy = class {
    ...
    get_group_by_fields() {
      ...
      this.group_by_fields[this.doctype] = fields.concat(tag_field).sort((a, b) => __(cstr(a.label)).localeCompare(cstr(__(b.label))));
    ...
    get_group_by_field_label() {
      let field = this.group_by_fields[this.group_by_doctype].find((field2) => field2.fieldname == this.group_by_field);
 ...
 * @license MIT
 */
//# sourceMappingURL=report.bundle.LXP4J2DV.js.map
