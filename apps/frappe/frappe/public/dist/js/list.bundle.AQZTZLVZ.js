(() => {
  ...
  // frappe-html:/home/nirosh/frappe-bench/apps/frappe/frappe/public/js/frappe/ui/listing.html
...
`;
  ...
  // frappe-html:/home/nirosh/frappe-bench/apps/frappe/frappe/public/js/frappe/ui/filters/edit_filter.html
...
`;
  ...
  // frappe-html:/home/nirosh/frappe-bench/apps/frappe/frappe/public/html/print_template.html
...
`;
  ...
  var FilterArea = class {
    ...
    set_standard_filter(filters) {
      ...
      let out = filters.reduce((out2, filter) => {
        ...
        if (fields_dict[fieldname] && (condition === "=" || condition === "like" && ((_b = (_a = fields_dict[fieldname]) == null ? void 0 : _a.df) == null ? void 0 : _b.fieldtype) != "Link")) {
        ...
        primary_action: ({ value }) => {
          ...
          frappe.call({
            ...
            if (failed.length && !r._server_messages) {
              ...
              frappe.throw(__("Cannot update {0}", [
  ...
  frappe.views.ListView = class ListView extends frappe.views.BaseList {
    ...
    constructor(opts) {
      super(opts);
      this.show();
      this.debounced_refresh = frappe.utils.debounce(this.process_document_refreshes.bind(this), 2e3);
    }
    has_permissions() {
    ...
    get_no_result_message() {
      ...
      let new_button_label = has_filters_set ? __("Create a new {0}", [__(this.doctype)], "Create a new document from list view") : __("Create your first {0}", [__(this.doctype)], "Create a new document from list view");
    ...
    get_form_link(doc) {
      ...
      return `/app/${encodeURIComponent(frappe.router.slug(frappe.router.doctype_layout || this.doctype))}/${encodeURIComponent(cstr(doc.name))}`;
    }
    get_seen_class(doc) {
    ...
    process_document_refreshes() {
      ...
      this.pending_document_refreshes = this.pending_document_refreshes.filter((d) => names.indexOf(d.name) === -1);
      if (!names.length)
        return;
  ...
  frappe.views.ListViewSelect = class ListViewSelect {
    ...
    setup_kanban_boards() {
      ...
      function fetch_kanban_board(doctype) {
        frappe.db.get_value("Kanban Board", { reference_doctype: doctype }, "name", (board) => {
    ...
    get_email_accounts() {
      ...
      accounts.forEach((account) => {
        ...
        let display_name = ["All Accounts", "Sent Mail", "Spam", "Trash"].includes(account.email_id) ? __(account.email_id) : account.email_account;
  ...
  // frappe-html:/home/nirosh/frappe-bench/apps/frappe/frappe/public/js/frappe/list/list_sidebar.html
...
`;
  ...
  // frappe-html:/home/nirosh/frappe-bench/apps/frappe/frappe/public/js/frappe/list/list_sidebar_stat.html
...
`;
  ...
  // frappe-html:/home/nirosh/frappe-bench/apps/frappe/frappe/public/js/frappe/list/list_view_permission_restrictions.html
...
`;
      ...
      return new Promise((resolve) => {
        if (calendar_name === "default") {
          ...
          frappe.model.with_doc("Calendar View", calendar_name, () => {
            ...
            if (!doc) {
              frappe.show_alert(__("{0} is not a valid Calendar. Redirecting to default Calendar.", [
                calendar_name.bold()
              ]));
  ...
  // frappe-html:/home/nirosh/frappe-bench/apps/frappe/frappe/public/js/frappe/views/image/image_view_item_row.html
...
`;
  ...
  // frappe-html:/home/nirosh/frappe-bench/apps/frappe/frappe/public/js/frappe/views/image/photoswipe_dom.html
...
<div class="pswp" tabindex="-1" role="dialog" aria-hidden="true">
  ...
  // frappe-html:/home/nirosh/frappe-bench/apps/frappe/frappe/public/js/frappe/views/kanban/kanban_board.html
  ...
  // frappe-html:/home/nirosh/frappe-bench/apps/frappe/frappe/public/js/frappe/views/kanban/kanban_column.html
  ...
  // frappe-html:/home/nirosh/frappe-bench/apps/frappe/frappe/public/js/frappe/views/kanban/kanban_card.html
...
//# sourceMappingURL=list.bundle.AQZTZLVZ.js.map
